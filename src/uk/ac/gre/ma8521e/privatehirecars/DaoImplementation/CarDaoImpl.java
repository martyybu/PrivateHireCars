...
public class CarDaoImpl implements CarDao {
    ...
    public List<Car> getAllCar(int ID) {
        ...
        try {
            ...
            while (rs.next()) {
                Car car1 = new Car(rs.getString("VIN"), rs.getString("plateNo"), rs.getInt("seats"), rs.getString("brand"), rs.getString("model"));
                car.add(car1);
            }
    ...
    public Car getCar(String ID) {
        ...
        try {
            ...
            rs = stmt.executeQuery();
            while (rs.next()) {
                car = new Car(rs.getString("VIN"), rs.getString("plateNo"), rs.getInt("seats"), rs.getString("brand"),rs.getString("model"));
            }
        } catch (SQLException e) {
            return null;
        } finally {
